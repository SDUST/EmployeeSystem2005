...
<body>
    <form id="form1" runat="server">
        <div style="text-align: left">
                        ...
                        <table style="border-right: #339999 1px solid; border-top: #339999 1px solid; border-left: #339999 1px solid;
                            ...
                            <tr>
                                ...
                                <td style="width: 105px">
                                    <asp:TextBox ID="txtIDCard" runat="server" Width="70px"></asp:TextBox></td>
                                <td style="width: 77px">
                                    婚姻状态</td>
                                <td style="width: 126px">
                                    <asp:DropDownList ID="selMarry" runat="server" Width="70px">
                                ...
                                <td style="width: 79px">
                                    ...
                                    最高学历</span></td>
                                <td style="width: 104px; font-size: 10pt; font-family: 宋体;">
                                    <asp:DropDownList ID="selDiploma" runat="server" DataSourceID="SqlDataSource2" DataTextField="fun_name"
                                        DataValueField="combine_cd" OnDataBound="selDiploma_DataBound" Width="70px">
                                    </asp:DropDownList></td>
                            </tr>
                            <tr style="font-size: 9pt; font-family: Times New Roman">
                                ...
                                <td style="width: 126px">
                                    <asp:DropDownList ID="selNation" runat="server" DataSourceID="SqlDataSource1" DataTextField="fun_name"
                                        DataValueField="fun_name" OnDataBound="selNation_DataBound" Width="70px">
                                    </asp:DropDownList></td>
                                <td style="width: 79px">
                                    邮 &nbsp; &nbsp; &nbsp;&nbsp; 编</td>
                                <td style="width: 104px">
                                    <asp:TextBox ID="txtPostalcode" runat="server" Width="70px"></asp:TextBox></td>
                            </tr>
                            <tr style="font-size: 9pt; font-family: Times New Roman">
                                <td style="width: 75px">
                                    联 系 人</td>
                                <td style="width: 105px">
                                    <asp:TextBox ID="txtLinkman" runat="server" Width="70px"></asp:TextBox></td>
                                <td style="width: 77px">
                                    联系电话</td>
                                <td style="width: 126px">
                                    <asp:TextBox ID="txtPhone" runat="server" Width="70px"></asp:TextBox></td>
                                <td style="width: 79px">
                                    电子邮件</td>
                                <td style="width: 104px">
                                    <asp:TextBox ID="txtEmail" runat="server" Width="70px"></asp:TextBox></td>
                            </tr>
                            <tr style="font-size: 9pt; font-family: Times New Roman">
                                <td style="width: 75px">
                                    合同区分</td>
                                ...
                                <td style="width: 77px">
                                    家庭住址</td>
                                <td style="width: 126px">
                                    <asp:TextBox ID="txtAddress" runat="server" Width="70px"></asp:TextBox></td>
                                <td colspan="2">
                ...
                <tr style="font-size: 9pt; font-family: Times New Roman">
                    <td colspan="3">
                        <table style="height: 60px; border-right: #009999 1px solid; border-top: #009999 1px solid;
                            border-left: #009999 1px solid; border-bottom: #009999 1px solid;" width="100%">
                            <tr style="background-image: url(images/topBar_bg.gif)">
                            ...
                            <tr>
                                ...
                                <td style="width: 97px; height: 16px">
                                    <asp:TextBox ID="txtEmpCd" runat="server" Width="70px"></asp:TextBox></td>
                                <td style="width: 67px; height: 16px; text-align: left;">
                                    卡编号</td>
                                <td style="width: 115px; height: 16px">
                                    <asp:TextBox ID="txtTimecard" runat="server" Width="70px"></asp:TextBox></td>
                                ...
                                <td style="width: 52px; height: 16px; text-align: left;">
                                    <asp:DropDownList ID="selDept" runat="server" DataSourceID="ObjectDataSource1" DataTextField="dept_name"
                                        DataValueField="dept_cd" OnDataBound="selDept_DataBound" Width="70px">
                                    </asp:DropDownList>
                                </td>
                                ...
                                <td style="width: 79px; height: 16px; text-align: left;" colspan="2">
                                    <asp:DropDownList ID="selPj" runat="server" DataSourceID="SqlDataSource7" DataTextField="dept_name"
                                        DataValueField="dept_cd" OnDataBound="selPj_DataBound" Width="70px">
                                    </asp:DropDownList>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td style="width: 52px; text-align: left;">
                                    <asp:TextBox ID="txtLevel" runat="server" Width="70px"></asp:TextBox></td>
                                <td style="width: 69px; text-align: left;">
                                    员工区分</td>
                                <td style="width: 79px; text-align: left;" colspan="2">
                                    <asp:DropDownList ID="selEmpClass" runat="server" Width="70px">
                            ...
                            <tr>
                                ...
                                <td style="width: 72px; text-align: left;">
                                    入社前工龄</td>
                                <td style="width: 52px; text-align: left;">
                                    <asp:TextBox ID="txtForwardWorkYear" runat="server" Width="70px"></asp:TextBox></td>
                                <td style="width: 69px; text-align: left;">
                                    入社后工龄</td>
                                <td colspan="2" style="width: 79px; text-align: left;">
                                    <asp:TextBox ID="txtAfterWorkYear" runat="server" Width="70px"></asp:TextBox></td>
                            </tr>
                            <tr>
                                <td style="width: 67px; text-align: left;">
                                    宿 &nbsp; &nbsp; &nbsp;&nbsp; 舍</td>
                                <td style="width: 97px">
                                    <asp:TextBox ID="txtDorm" runat="server" Width="70px"></asp:TextBox></td>
                                <td style="width: 67px; text-align: left;">
                                    床 位</td>
                                <td style="width: 115px">
                                    <asp:TextBox ID="txtBed" runat="server" Width="70px"></asp:TextBox></td>
                                <td style="width: 72px; text-align: left;">
                                    备 注</td>
                                <td colspan="4" style="text-align: left">
                                    <asp:TextBox ID="txtMemo" runat="server" Width="168px"></asp:TextBox></td>
                            </tr>
                        </table>
                    </td>
                </tr>
            ...
            <asp:SqlDataSource ID="SqlDataSource7" runat="server" ConnectionString="<%$ ConnectionStrings:SanXI_EmpConnectionString %>"
