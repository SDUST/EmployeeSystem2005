    ...
    <form id="form1" runat="server">
        <div>
            <table style="border-right: #339999 1px solid; border-top: #339999 1px solid; border-left: #339999 1px solid;
                width: 423px; border-bottom: #339999 1px solid; height: 89px">
                <tr>
                    <td colspan="3" style="background-image: none; height: 1px">
                        员工姓名：<asp:Label ID="empName" runat="server" Text="Label" Width="79px"></asp:Label></td>
                </tr>
                <tr>
                    <td colspan="3">
                ...
                <tr>
                    ...
                    <td style="height: 25px">
                        任命日期<asp:TextBox ID="recordDate" runat="server" Width="70px"></asp:TextBox>&nbsp;<asp:ImageButton
                            ID="ImageButton1" runat="server" ImageUrl="~/images/013.gif" OnClientClick="fPopUpCalendarDlg(document.all.recordDate);return false;" />
        ...
        <asp:ObjectDataSource ID="ObjectDataSource2" runat="server" SelectMethod="GetDuty"
            TypeName="Bussiness.Duties"></asp:ObjectDataSource>
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="GetDutyByEmpcd"
            TypeName="Bussiness.Duties">
            <SelectParameters>
