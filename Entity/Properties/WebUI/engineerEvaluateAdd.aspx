...
<body>
    <form id="form1" runat="server">
        <table style="border-right: #339999 1px solid; border-top: #339999 1px solid; border-left: #339999 1px solid; border-bottom-width: 1px; border-bottom-color: #339999;" width="605">
            <tr style="background-image: url(images/topBar_bg.gif)">
                <td colspan="3">
                    <span style="font-size: 12pt">编号</span>：<asp:Label ID="Label1" runat="server" Text="Label"
                        Width="52px"></asp:Label><span style="font-size: 12pt">姓名</span>：<asp:Label ID="Label2"
                            runat="server" Text="Label" Width="56px"></asp:Label></td>
            </tr>
            <tr>
                <td valign="top" style="width: 206px; height: 25px;">
                    <span style="font-size: 12pt">评价日期</span><asp:TextBox ID="txtDate" runat="server"
                ...
                <td valign="top" style="width: 249px; height: 25px;">
                    <span style="font-size: 12pt">评价区分</span><asp:DropDownList ID="selClass" runat="server"
                        DataSourceID="SqlDataSource1" DataTextField="fun_name" DataValueField="combine_cd"
                        OnDataBound="selClass_DataBound" Width="116px">
                    </asp:DropDownList>
                    &nbsp;&nbsp;</td>
                <td valign="top" style="height: 25px">
                    &nbsp;<span style="font-size: 12pt">评价人</span><asp:TextBox ID="txtEmpName" runat="server"
                        Width="60px"></asp:TextBox></td>
            </tr>
        </table>
        <table style="height: 89px; border-right: #339999 1px solid; border-top: #339999 1px solid;
            border-left: #339999 1px solid; border-bottom: #339999 1px solid;" width="605">
            <tr>
                <td colspan="1" style="width: 40px" valign="middle">
                    <span style="font-size: 12pt">备注</span></td>
                <td valign="top" colspan="4">
                    <asp:TextBox ID="txtMemo" runat="server" Height="72px" TextMode="MultiLine" Width="98%"></asp:TextBox></td>
            </tr>
        </table>
        <div style="OVERFLOW-X: hidden; OVERFLOW: scroll; WIDTH: 598px; HEIGHT: 200px">
        <table width="610">
            <tr>
                <td colspan="5" rowspan="1" style="height: 50px" valign="top">
                    <asp:GridView ID="GVevaluation" runat="server" AutoGenerateColumns="False" DataSourceID="ObjectDataSource1"
                        Width="576px" Height="120px" OnRowDataBound="GVevaluation_RowDataBound">
                        <Columns>
        ...
        <table width="605">
            <tr>
                <td rowspan="3" style="width: 259px; text-align: right">
                    &nbsp; &nbsp;
        ...
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="GetPjEbyEmpcd"
            TypeName="Bussiness.Pjevaluations">
            <SelectParameters>
