<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="companyEvaluate.aspx.cs" Inherits="companyEvaluate" Title="百易人事管理系统" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <table style="width: 767px; border-top-width: 1px; border-left-width: 1px; border-left-color: #339999;
        ...
        <tr>
            <td colspan="3" valign="top" style="height: 72px">
                <table style="border-right: #339999 1px solid; border-top: #339999 1px solid; border-left: #339999 1px solid;
                    ...
                    <tr class="topbg">
                        <td colspan="6" style="text-align: left; vertical-align: middle; height: 15px;">
                            <span style="font-size: 10pt">员工公司评价信息检索</span></td>
                    </tr>
                    <tr>
                        <td style="height: 20px; width: 142px;">
                            编 &nbsp; &nbsp;号
                            <asp:TextBox ID="txtEmpCd" runat="server" Width="60px" MaxLength="20"></asp:TextBox></td>
                        <td style="height: 20px; width: 130px;">
                            姓 &nbsp; 名
                            <asp:TextBox ID="txtEmpName" runat="server" Width="60px" MaxLength="20"></asp:TextBox></td>
                        <td style="height: 20px; width: 163px;">
                            部 &nbsp; 门
                            <asp:DropDownList ID="selDeptCd" runat="server" DataSourceID="SqlDataSource1" DataTextField="dept_name"
                                DataValueField="dept_cd" Width="109px" OnDataBound="selDeptCd_DataBound">
                            </asp:DropDownList>
                        </td>
                        <td style="height: 20px">
                            工&nbsp; 程
                            <asp:DropDownList ID="selPjCd" runat="server" DataSourceID="SqlDataSource2" DataTextField="dept_name"
                                DataValueField="dept_cd" Width="95px" OnDataBound="selPjCd_DataBound">
                            </asp:DropDownList>
                        </td>
                        <td style="height: 20px">
                            区 &nbsp; 分
                            <asp:DropDownList ID="selContract" runat="server" Width="55px" DataSourceID="ObjectDataSource1"
                                DataTextField="fun_name" DataValueField="combine_cd" OnDataBound="selContract_DataBound">
                            </asp:DropDownList>&nbsp;
                        </td>
                        <td style="height: 20px">
                            <asp:Button ID="btnQuery" runat="server" CssClass="button" Text="查询" Width="55px"
                                OnClick="btnQuery_Click" /></td>
                    </tr>
                    <tr>
                        <td colspan="6" style="height: 21px">
                            开始日期
                            <asp:TextBox ID="txtBegin" runat="server" Width="70px"></asp:TextBox>
                            <asp:ImageButton ID="imageBegin" runat="server" ImageUrl="~/images/datetime.gif"
                                OnClientClick="fPopUpCalendarDlg(document.all.ctl00_ContentPlaceHolder1_txtBegin);return false;" />
                            ～结束日期
                            <asp:TextBox ID="txtTermination" runat="server" Width="70px"></asp:TextBox>
                            <asp:ImageButton ID="imageEnd" runat="server" ImageUrl="~/images/datetime.gif" OnClientClick="fPopUpCalendarDlg(document.all.ctl00_ContentPlaceHolder1_txtTermination);return false;" />
                            <asp:CompareValidator ID="CompareValidator1" runat="server" ControlToCompare="txtTermination"
                                ControlToValidate="txtBegin" ErrorMessage="开始日期不能大于结束日期" Operator="LessThanEqual"
                                Type="Date">&nbsp</asp:CompareValidator></td>
                    </tr>
                </table>
    </td> </tr>
    <tr>
        <td style="background-image: url(../images/topBar_bg.gif); height: 14px; text-align: left" colspan="3">
            评价信息 &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
            &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
            &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
            &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
            &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
            <asp:LinkButton ID="lnkPrint"
                                runat="server" OnClick="lnkPrint_Click">打印报表</asp:LinkButton>
                ...
                <tr>
                    <td colspan="3" rowspan="2" valign="top">
                        <asp:GridView ID="GVEmps" runat="server" AutoGenerateColumns="False" DataKeyNames="emp_cd"
                            Visible="False" Width="100%" OnRowDataBound="GVEmps_RowDataBound" AllowPaging="True"
                            OnDataBound="GVEmps_DataBound" OnPageIndexChanged="GVEmps_PageIndexChanged" PageSize="15"
                            DataSourceID="ObjectDataSource3" OnSelectedIndexChanged="GVEmps_SelectedIndexChanged">
                            <Columns>
    ...
    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="GetCEC"
        TypeName="Business.Emps"></asp:ObjectDataSource>
