...
public partial class companyEvaluate : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!new UserPopedeom().GetPopedom("companyEvaluate", Session["userCd"].ToString()))
        {
        ...
        else
        {
            ...
            txtTermination.Attributes.Add("readonly", "readonly");
        }
    }
    protected void btnQuery_Click(object sender, EventArgs e)
    {
        ...
        if (txtBegin.Text != "")
            dateBegin = Convert.ToDateTime(txtBegin.Text);
        DateTime dateEnd = new DateTime();
        if (txtTermination.Text != "")
            dateEnd = Convert.ToDateTime(txtTermination.Text);
