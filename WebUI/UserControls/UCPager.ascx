...
<table style="width: 388px; height: 1px">
    <tr>
        <td align="right" style="width: 281px; height: 11px; text-align: left" valign="top">
            ...
            <asp:LinkButton ID="LnkLast" runat="server" Font-Underline="False" OnClick="LnkLast_Click" CausesValidation="False" >尾页</asp:LinkButton>
            <asp:DropDownList ID="DDLpage" runat="server" AutoPostBack="True" Height="20px"
                 Width="35px" OnSelectedIndexChanged="DDLpage_SelectedIndexChanged">
            </asp:DropDownList></td>
        <td align="left" style="width: 217px; height: 11px; text-align: right" valign="middle">
